...
#[ORM\Entity(repositoryClass: ClassificationPerteRepository::class)]
class ClassificationPerte
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\OneToMany(mappedBy: 'classificationPerte', targetEntity: EventDatabase::class)]
    ...
    public function addEventDatabase(EventDatabase $eventDatabase): self
    {
        if (!$this->eventDatabases->contains($eventDatabase)) {
            ...
            $eventDatabase->setClassificationPerte($this);
        }
    ...
    public function removeEventDatabase(EventDatabase $eventDatabase): self
    {
        if ($this->eventDatabases->removeElement($eventDatabase)) {
            ...
            if ($eventDatabase->getClassificationPerte() === $this) {
                $eventDatabase->setClassificationPerte(null);
            }
        }
