...
#[ORM\Entity(repositoryClass: DecisioncasRepository::class)]
class Decisioncas
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(mappedBy: 'decisioncas', targetEntity: EventDatabase::class)]
    ...
    public function addEventDatabase(EventDatabase $eventDatabase): self
    {
        if (!$this->eventDatabases->contains($eventDatabase)) {
            ...
            $eventDatabase->setDecisioncas($this);
        }
    ...
    public function removeEventDatabase(EventDatabase $eventDatabase): self
    {
        if ($this->eventDatabases->removeElement($eventDatabase)) {
            ...
            if ($eventDatabase->getDecisioncas() === $this) {
                $eventDatabase->setDecisioncas(null);
            }
        }
